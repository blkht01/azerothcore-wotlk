...
<<<<<<< HEAD
        if ((sWorld->getIntConfig(CONFIG_INSTANT_TAXI) == 3 && appendValue & UNIT_NPC_FLAG_FLIGHTMASTER) || (target->GetPlayerSetting("store", 3).value != 0 && appendValue & UNIT_NPC_FLAG_FLIGHTMASTER)) // Qeme
=======
...
>>>>>>> a92114adfffdfffd7ad94a7aa7a41e48022b885d
